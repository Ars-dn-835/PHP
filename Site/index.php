...
<?php
    session_start();
    $username['num'] = $_GET['username'];
    $choose['num'] = $_GET['choose'];
    $rememberme['num'] = $_GET['rememberme'];

    echo $username['num'].'</br>';
    echo $choose['num'].'</br>';
    echo $rememberme['num'].'</br>';
?>
    <a href='http://site/index.php?username=b&choose=Choose...'>Forward</a>
</body>
</html>
